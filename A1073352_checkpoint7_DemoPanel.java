...
public class A1073352_checkpoint7_DemoPanel extends JPanel {
    //Description : the obstacle block set.
    private ArrayList<A1073352_checkpoint7_Block> obstacle;
    //Description : the sand block set.
    private ArrayList<A1073352_checkpoint7_Block> sands;
    ...
    private ArrayList<A1073352_checkpoint7_Block> path;
    //Description : while moving, the target block;
    private A1073352_checkpoint7_Block target;
    public A1073352_checkpoint7_DemoPanel(A1073352_checkpoint7_Player player, ArrayList<A1073352_checkpoint7_Block> obstacle,int scaler,ArrayList<A1073352_checkpoint7_Block> sands){
        ...
        this.sands = sands;
        this.add(player);
        this.path = new ArrayList<A1073352_checkpoint7_Block>();
        this.target = null;
        ...
        /********************************************************************************************
         START OF YOUR CODE
         ********************************************************************************************/
        centerX = mapImg.getWidth(null)/ (2 * scaler);//panel's center
     	centerY = mapImg.getHeight(null)/ (2 * scaler);
    ...
    public void paintComponent(Graphics g){
        ...
        if(!player.getMoving()){
            ...
            g.setColor(color);
            for(A1073352_checkpoint7_Block x : path){
    ...
    public void setPath(ArrayList<A1073352_checkpoint7_Block> path){
        this.path = path;
    }
    ...
    public void setTarget(A1073352_checkpoint7_Block target){
        this.target = target;
    }
    public A1073352_checkpoint7_Block getTarget(){
        return this.target;
    }
}
